...
namespace CarInfo.DataAccess.Persistence.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    registeredOffice = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    airBagDetails = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    bootspace = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_car_carTransmissionTypes_carTransmissionId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_car_manufacturer_manifactureId",
                        column: x => x.manifactureId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_car_carTransmissionId",
                table: "car",
                column: "carTransmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_car_manifactureId",
                table: "car",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_manufacturer_contactPerson",
                table: "manufacturer",
